...
const PollPage = ({dispatch, authedUser, question, author}) => {
    ...
    return (
        <div>
            ...
            <div className="flex justify-center">
                <h2 className="text-2xl font-bold mt-6">Vote for an option!</h2>
            </div>

            <div className="grid grid-cols-2 gap-4 mt-4">

                <button onClick={handleOptionOne} disabled={hasVoted}
                        className={"p-2 rounded-xl bg-zinc-100 hover:shadow-xl transition " + (hasVotedForOptionOne ? "bg-sky-400" : "")}>
                ...
                <button onClick={handleOptionTwo} disabled={hasVoted}
                        className={"p-2 rounded-xl bg-zinc-100 hover:shadow-xl transition " + (hasVotedForOptionTwo ? "bg-sky-400" : "")}>
